...
- `framework/core/templates/ADR.md.j2` — MADR-shaped template.
- `framework/index/modules.json` — to resolve which modules are touched.

### Accept phase
- Path to the existing `docs/adr/ADR-NNN-*.md`.
- The final review report (`framework/reports/review-*.md`).
