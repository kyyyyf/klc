# Agent prompt — KLC-02 · xs-build:work

Ticket: **KLC-02** · track: **XS** · kind: **bug**
...
work is done, the human runs `klc ack KLC-02` (with `--pick N` if
required) to confirm.
...
- [✓] `.klc/tickets/KLC-02/raw.md`
- [✓] `.klc/tickets/KLC-02/spec.md`
...
`klc ack KLC-02 --pick <N>`, where N is:
