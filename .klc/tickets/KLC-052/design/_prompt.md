# Agent prompt — KLC-052 · design:work
...
work is done, the human runs `klc ack KLC-052` (with `--pick N` if
required) to confirm.
...
- [✓] `.klc/tickets/KLC-052/test-plan.md`
...
`klc ack KLC-052 --pick <N>`, where N is:
