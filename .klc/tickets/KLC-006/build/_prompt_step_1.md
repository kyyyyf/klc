# Agent prompt — KLC-006 · build:work · step-1
...
- Full impl-plan: `.klc/tickets/KLC-006/impl-plan.md`
- Full spec: `.klc/tickets/KLC-006/spec.md`
- Full test-plan: `.klc/tickets/KLC-006/test-plan.md`
...
After tests are green, emit `IMPL_STEP_OK KLC-006 step-1` and
run `klc step KLC-006 2` to get the next step's card,
or `klc ack KLC-006 --pick 1` if this was the last step.
