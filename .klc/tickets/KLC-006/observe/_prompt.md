# Agent prompt — KLC-006 · observe:work
...
When the observation window closes, run `klc ack KLC-006 --pick 1` (clean), `--pick 2` (regression, auto-reopens build), or `--pick 3` (rollback).
