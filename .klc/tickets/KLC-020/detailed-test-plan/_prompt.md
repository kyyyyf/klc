# Agent prompt — KLC-020 · detailed-test-plan:work
...
work is done, the human runs `klc ack KLC-020` (with `--pick N` if
required) to confirm.
...
- [✓] `.klc/tickets/KLC-020/spec.md`
- [✓] `.klc/tickets/KLC-020/test-plan.md`
- [✓] `.klc/tickets/KLC-020/design/options.md`
- [✓] `.klc/tickets/KLC-020/impl-plan.md`
...
`klc ack KLC-020 --pick <N>`, where N is:
