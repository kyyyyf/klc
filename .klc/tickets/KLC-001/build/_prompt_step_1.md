# Agent prompt — KLC-001 · build:work · step-1

Ticket: **KLC-001** · track: **S** · kind: **feature**
...
- Full impl-plan: `.klc/tickets/KLC-001/impl-plan.md`
- Full spec: `.klc/tickets/KLC-001/spec.md`
- Full test-plan: `.klc/tickets/KLC-001/test-plan.md`
...
After tests are green, emit `IMPL_STEP_OK KLC-001 step-1` and
run `klc step KLC-001 2` to get the next step's card,
or `klc ack KLC-001 --pick 1` if this was the last step.
