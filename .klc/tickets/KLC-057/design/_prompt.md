# Agent prompt — KLC-057 · design:work
...
work is done, the human runs `klc ack KLC-057` (with `--pick N` if
required) to confirm.
...
- [✓] `.klc/tickets/KLC-057/spec.md`
- [✓] `.klc/tickets/KLC-057/test-plan.md`
...
`klc ack KLC-057 --pick <N>`, where N is:
