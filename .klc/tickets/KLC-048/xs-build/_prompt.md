# Agent prompt — KLC-048 · xs-build:work
...
work is done, the human runs `klc ack KLC-048` (with `--pick N` if
required) to confirm.
...
- [✓] `.klc/tickets/KLC-048/raw.md`
- [✓] `.klc/tickets/KLC-048/spec.md`
...
`klc ack KLC-048 --pick <N>`, where N is:
