# Agent prompt — KLC-046 · detailed-test-plan:work
...
work is done, the human runs `klc ack KLC-046` (with `--pick N` if
required) to confirm.
...
- [✓] `.klc/tickets/KLC-046/spec.md`
- [✓] `.klc/tickets/KLC-046/test-plan.md`
- [✓] `.klc/tickets/KLC-046/design/options.md`
- [✓] `.klc/tickets/KLC-046/impl-plan.md`
...
`klc ack KLC-046 --pick <N>`, where N is:
