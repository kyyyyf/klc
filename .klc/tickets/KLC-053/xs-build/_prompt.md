# Agent prompt — KLC-053 · xs-build:work
...
work is done, the human runs `klc ack KLC-053` (with `--pick N` if
required) to confirm.
...
- [✓] `.klc/tickets/KLC-053/raw.md`
- [✓] `.klc/tickets/KLC-053/spec.md`
...
`klc ack KLC-053 --pick <N>`, where N is:
