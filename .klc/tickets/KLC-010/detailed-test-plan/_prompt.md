# Agent prompt — KLC-010 · detailed-test-plan:work
...
work is done, the human runs `klc ack KLC-010` (with `--pick N` if
required) to confirm.
...
- [✓] `.klc/tickets/KLC-010/spec.md`
- [✓] `.klc/tickets/KLC-010/test-plan.md`
- [✓] `.klc/tickets/KLC-010/design/options.md`
- [✓] `.klc/tickets/KLC-010/impl-plan.md`
...
`klc ack KLC-010 --pick <N>`, where N is:
