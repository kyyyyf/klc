# Agent prompt — KLC-062 · observe:work
...
When the observation window closes, run `klc ack KLC-062 --pick 1` (clean), `--pick 2` (regression, auto-reopens build), or `--pick 3` (rollback).
