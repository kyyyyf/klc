# Agent prompt — KLC-022 · detailed-test-plan:work
...
- [✓] `.klc/tickets/KLC-022/spec.md`
- [✓] `.klc/tickets/KLC-022/test-plan.md`
- [✓] `.klc/tickets/KLC-022/design/options.md`
- [✓] `.klc/tickets/KLC-022/impl-plan.md`
...
`klc ack KLC-022 --pick <N>`, where N is:
