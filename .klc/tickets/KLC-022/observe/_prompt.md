# Agent prompt — KLC-022 · observe:work
...
When the observation window closes, run `klc ack KLC-022 --pick 1` (clean), `--pick 2` (regression, auto-reopens build), or `--pick 3` (rollback).
