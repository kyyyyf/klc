# Agent prompt — KLC-017 · build:work · step-1

Ticket: **KLC-017** · track: **S** · kind: **tech**
...
- Full impl-plan: `.klc/tickets/KLC-017/impl-plan.md`
- Full spec: `.klc/tickets/KLC-017/spec.md`
- Full test-plan: `.klc/tickets/KLC-017/test-plan.md`
...
After tests are green, emit `IMPL_STEP_OK KLC-017 step-1` and
run `klc step KLC-017 2` to get the next step's card,
or `klc ack KLC-017 --pick 1` if this was the last step.
