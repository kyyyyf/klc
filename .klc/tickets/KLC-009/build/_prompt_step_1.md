# Agent prompt — KLC-009 · build:work · step-1
...
- Full impl-plan: `.klc/tickets/KLC-009/impl-plan.md`
- Full spec: `.klc/tickets/KLC-009/spec.md`
- Full test-plan: `.klc/tickets/KLC-009/test-plan.md`
...
After tests are green, emit `IMPL_STEP_OK KLC-009 step-1` and
run `klc step KLC-009 2` to get the next step's card,
or `klc ack KLC-009 --pick 1` if this was the last step.
