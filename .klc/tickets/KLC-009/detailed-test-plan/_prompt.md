# Agent prompt — KLC-009 · detailed-test-plan:work
...
- [✓] `.klc/tickets/KLC-009/spec.md`
- [✓] `.klc/tickets/KLC-009/test-plan.md`
- [✗] `.klc/tickets/KLC-009/design/options.md`
- [✓] `.klc/tickets/KLC-009/impl-plan.md`
...
`klc ack KLC-009 --pick <N>`, where N is:
