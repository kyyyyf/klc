# Agent prompt — KLC-007 · build:work · step-1
...
- Full impl-plan: `.klc/tickets/KLC-007/impl-plan.md`
- Full spec: `.klc/tickets/KLC-007/spec.md`
- Full test-plan: `.klc/tickets/KLC-007/test-plan.md`
...
After tests are green, emit `IMPL_STEP_OK KLC-007 step-1` and
run `klc step KLC-007 2` to get the next step's card,
or `klc ack KLC-007 --pick 1` if this was the last step.
